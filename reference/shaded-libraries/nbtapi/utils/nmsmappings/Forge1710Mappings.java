...
public class Forge1710Mappings {
    ...
    public static String toString(Object nbtTagCompound) {
        ...
        try {
            return (String)crucible_toString.invoke(nbtTagCompound, new Object[0]);
        }
        catch (Exception ex) {
    ...
    static {
        ...
        try {
            crucible_toString = Class.forName("net.minecraft.nbt.NBTTagCompound").getDeclaredMethod("crucible_toString", new Class[0]);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
